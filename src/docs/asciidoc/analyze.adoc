...
include::{snippets}/analyze/download/success/path-parameters.adoc[]
...
=== AI 분석 README 결과 불러오기 실패 (아직 AI 가 리드미 생성을 완료하지 못한 경우)

==== HTTP Request

include::{snippets}/analyze/download/fail/http-request.adoc[]

==== Path Variable

include::{snippets}/analyze/download/fail/path-parameters.adoc[]

==== HTTP Response

include::{snippets}/analyze/download/fail/http-response.adoc[]
